  ...
  <div className="bg-[#fff]">
    <div className="max-w-[1280px] mx-auto flex gap-3 justify-between items-center flex-wrap px-4 lg:px-8 py-3">
      <div className="flex items-center gap-3 w-full lg:w-auto">
        <button className="bg-[#1F1D14] text-[#fff] flex py-[12px] px-[20px] lg:px-[40px] rounded-[5px] gap-2">
      ...
      <div className="flex gap-4 mt-4 lg:mt-0">
        ...
        <button className="bg-[#F2F2F2] text-[#111] flex py-[12px] px-[20px] lg:px-[40px] rounded-[5px] gap-2">
